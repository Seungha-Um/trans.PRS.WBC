...
We implemented a phenome-wide association study (PheWAS) and tree-ensemble models to examine associations between genetic predisposition to WBC count and clinical phenotypes, as well as longitudinal WBC trajectories.
